...
if($rows > 0){
    ...
    $_SESSION['CUser_Id'] = $data['User_Id'];
  $_SESSION['CUsername'] = $data['Username'];
  $_SESSION['CFullName'] = $data['FullName'] ;
  $_SESSION['CEmail'] = $data['Email'] ;
 
  $_SESSION['CRole'] = $data['Role'] ;
  $_SESSION['CAuserloggedin'] = true;
  header('location:index.php');
} 
else{
  echo "<script>
