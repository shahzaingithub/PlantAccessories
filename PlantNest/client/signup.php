...
//    $role = mysqli_real_escape_string($conn,$_POST['role']);
 ...
 if($error_message == '' && $role ==0){
    $Regquery = "SELECT * FROM users WHERE Email = '$email' AND Role = $role";
    ...
    $addquery ="INSERT INTO `users`(`username`,`fullName`,`Email`,`Password`,`role`) VALUES ('$uname','$fname','$email','$password',$role)";
...
<!-- Mirrored from htmldemo.net/lukani/lukani/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2023 08:18:49 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="account_form">
                        ...
                        <p>
                            ...
                            <p>
                                ...
                                <input type="text" name="username" placeholder="Enter Your a Username" required>
                            </p>
                            <p>
