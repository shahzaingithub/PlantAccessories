...
<!-- Mirrored from kamleshyadav.com/html/splashdash/html/b5/light/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2023 08:21:19 GMT -->
<head>
                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="breadcrumb-list">
                                <ul>
                                    ...
                                    <li class="breadcrumb-link active">Cards</li>
                                </ul>
                            </div>
                        </div>
                    </div>
										...
										<div class="prooduct-details-box">                                 
										  <div class="media">
											...
											<div class="media-body ms-0">
											  ...
											  <div class="price"> 
												<div class="text-muted me-2">Products:- 122</div>
											  </div>
											  <div class="avaiabilty">
												<div class="text-success">Wallet Balance:- $13,575</div>
												<a href="javascript:;">Work Shop Now <i class="fas fa-angle-right"></i></a>
											  </div>
											</div>
										  </div>
										</div>
