...
if(isset($_POST['change'])){
    ...
    // echo "<script>alert('doneeee.$jid ');</script>";

   
  
    $update = "UPDATE `users` SET `Username`='$uname',`FullName`='$fname',`Password`='$password' WHERE `User_Id` = $jid";
    $rup = mysqli_query($conn,$update);
    if($rup){
      echo "<script>alert('updated Successfully sign out to see the difference');</script>";
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-content">
                        <form method="post">
                            ...
                            <p>Please Enter Your Details Below to Continue your Update</p>
                            <div class="ad-auth-form">
								<div class="ad-auth-feilds mb-30">
                                    <input type="text"  value="<?=$_SESSION['Username']?>" name="Username" class="ad-input" />
                                    ...
                                    <div class="ad-auth-form">
								<div class="ad-auth-feilds mb-30">
                                    <input type="text"  name="FullName" class="ad-input" value="<?=$_SESSION['FullName']?>" disabled/>
                                    <div class="ad-auth-icon">
                                        <svg 
										 xmlns="http://www.w3.org/2000/svg"
										 xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <div class="ad-auth-feilds mb-30">
                                    <input type="email"  name="Email" class="ad-input" value="<?=$_SESSION['Email']?>" disabled/>
                                    <div class="ad-auth-icon">
                            ...
                            <div class="ad-auth-btn">
                                <button type='submit'   name="change" class="ad-btn ad-login-member">Update</button>
                            </div>
