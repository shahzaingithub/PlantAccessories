...
if(isset($_SESSION['Auserloggedin'])  && $_SESSION['Auserloggedin'] ){
...
<!-- Mirrored from kamleshyadav.com/html/splashdash/html/b5/light/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2023 08:20:58 GMT -->
<head>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-content">
                        <form method="post">
                            ...
                            <h2><span class="primary">Admin</span>  Login</h2>
                            ...
                            <div class="ad-auth-btn">
                                <button  name="login" class="ad-btn ad-login-member" style="background-color:#79a206">Login</button>
                            </div>
...
<!-- Mirrored from kamleshyadav.com/html/splashdash/html/b5/light/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Aug 2023 08:20:59 GMT -->
</html>
